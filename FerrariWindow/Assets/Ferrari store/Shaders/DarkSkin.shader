...
Properties
    {
        ...
        _Contrast("Contrast", Range(0, 5.0)) = 0.5
        _Color ("Rim Color", Color) = (0.0,0.0,0.0,0.0)
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : COLOR
            {
                ...
                // return hsbColor;
                fixed4 color1 = hsbColor;
                color1.r = (color1.r + _Color.r)/2;
				color1.g = (color1.g + _Color.g)/2;
				color1.b = (color1.b + _Color.b)/2;
				return color1;
            }
            ENDCG
        } // Pass
